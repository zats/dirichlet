...
Download the repository as a zip file and unzip it. Then run the [example.ipynb](https://github.com/xuod/dirichlet/blob/master/example/example.ipynb) jupyter notebook in the `example` subfolder to perform the test and produce plots (if you have never used jupyter, see the [jupyter website](http://jupyter.org/)).
